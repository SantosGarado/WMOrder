...
public record GuiAction(Type type,UUID orderId,long amount,String value) {
    public enum Type { PREVIOUS,NEXT,REFRESH,SEARCH,MY_ORDERS,CREATE_OPEN,CREATE_ITEM,CREATE_ITEM_SELECT,CREATE_ITEM_PREVIOUS,CREATE_ITEM_NEXT,CREATE_AMOUNT,CREATE_DECLINE,COLLECTION,HISTORY,DETAILS,TOGGLE_FULFILLABLE,CYCLE_SORT,CYCLE_CATEGORY,
